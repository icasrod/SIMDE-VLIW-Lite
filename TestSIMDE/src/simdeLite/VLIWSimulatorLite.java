...
public class VLIWSimulatorLite {
	 ...
	 * @return Una configuración de máquina a partir de una lista de números separados por comas
	 * @throws ParameterException Si la lista de configuración no es correcta (número de unidades funcionales menor que el número de tipos de unidades funcionales menos uno, o alguna cantidad de unidades funcionales menor que 1)
	 */
